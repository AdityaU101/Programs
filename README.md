...
**My personal solutions to LeetCode problems, written in Java. One problem at a time.**
...
Requires **JDK 11+**. Tested with [Eclipse Temurin JDK 21](https://adoptium.net/).
...
<div align="center">
  <sub>Written in Java. Debugged with patience. Submitted with hope. 🫡</sub>
</div>
